   ...
   //char Char;
    ...
    do
    {
        ...
        case 1://caso de Conectivos proposicionais
            if(state == 4 || state == 0 || state == 1 || state == 3)
                break;
        ...
        case 5://fechar parenteses
            if(state == 1 || state == 5){
                if(ParenCounter + ParenCounter-- < ParenCounter ){ 
                    printf("Existe um parentese fechado sem estar aberto, na posição %d\n",i);
                    return 0;
                }
                break;
            }
